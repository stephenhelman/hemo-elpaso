...
export default async function EventAnnouncementsPage({ params }: Props) {
  ...
  const activeCount = event.announcements.filter((a) => a.active).length;
        ...
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-neutral-400">
              Post real-time updates to attendees
            </p>
          </div>
