      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Section title="Basic Information">
          <BilingualInput
            label="Event Title"
            name="title"
            value={{ en: formData.titleEn, es: formData.titleEs }}
            onChange={(v) =>
              updateFormData({
                titleEn: v.en,
                titleEs: v.es,
                slug: generateSlug(v.en),
              })
            }
            required
          />
          ...
          <BilingualInput
            label="Description"
            name="description"
            value={{ en: formData.descriptionEn, es: formData.descriptionEs }}
            onChange={(v) =>
              updateFormData({ descriptionEn: v.en, descriptionEs: v.es })
            }
            type="textarea"
            rows={4}
            required
