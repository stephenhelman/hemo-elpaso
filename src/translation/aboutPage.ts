...
export const boardOfDirectorsTranslation = {
  en: {
    eyebrow: "Leadership",
...
export const founderSpotlightTranslation = {
  en: {
    eyebrow: "Our Founder",
...
export const founderStoryTranslation = {
  en: {
    eyebrow: "Our Founder",
...
export const missionValuesTranslation = {
  en: {
